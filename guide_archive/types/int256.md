...
```aria
// Convert ETH to wei
func:eth_to_wei = int256(flt64:eth) {
    wei_per_eth: i256 = 1000000000000000000i256;
    pass((eth as i256) * wei_per_eth);
}

// Convert wei to ETH
func:wei_to_eth = flt64(int256:wei) {
    wei_per_eth: i256 = 1000000000000000000i256;
    pass((wei as flt64) / (wei_per_eth as flt64));
}
```
...
func:mod_pow = int256(int256:base, int256:exp, int256:modulus) {
    Result: i256 = 1i256;
    base = base % modulus;
...
func:transfer = Result<NIL>(Account->:from, Account->:to, int256:amount) {
