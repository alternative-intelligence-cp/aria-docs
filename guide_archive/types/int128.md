...
```aria
func:to_i64 = Result<int64>(int128:value) {
...
func:uuid_to_int = int128(string:uuid) {
    // Parse hex string
    pass(parse_hex_i128(uuid.remove("-")));
}

func:int_to_uuid = string(int128:value) {
    hex: string = to_hex(value);
    // Format as UUID
    pass(format_uuid(hex));
}
```
